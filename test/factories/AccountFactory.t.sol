...
import {GnosisAccountFactory} from "account-abstraction/gnosis/GnosisAccountFactory.sol";
...
contract AccountFactoryTestContract is Test {
    ...
    GnosisAccountFactory f;
    function setUp() public {
      e = new EntryPoint();
      aaModule = new EIP4337Manager(address(e));
      f = new GnosisAccountFactory(pf, singletonAddress, aaModule);
    }
